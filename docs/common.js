...
eval("(function () {\n  var $search = $('.header__search');\n  $search.on('click', function (e) {\n    var $self = $(this);\n\n    if (parseInt($self.css('border')) < 40) {\n      $self.not('.opened').addClass('opened').find('input[type=\"text\"]').trigger('focus');\n    }\n  });\n  $(window).on('click', function (e) {\n    if ($search.hasClass('opened') && !e.target.closest('.header__search')) {\n      e.preventDefault();\n      $search.removeClass('opened');\n    }\n  });\n})();//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/blocks/header/header.js\n");
